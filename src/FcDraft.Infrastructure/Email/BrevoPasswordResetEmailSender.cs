              ...
              <body style="margin:0;background:#f7f7f9;color:#16161c;font-family:Arial,sans-serif">
                <div style="max-width:560px;margin:0 auto;padding:40px 24px">
                  <div style="background:#fff;border:1px solid #e3e3e8;border-radius:16px;padding:32px">
                    ...
                    <p><a href="{{resetLink}}" style="display:inline-block;padding:14px 20px;background:#d4af37;color:#16161c;border-radius:10px;font-weight:700;text-decoration:none">Choose a new password</a></p>
