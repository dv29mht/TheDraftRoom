...
- Populate player Roles/Role++ and 4.5★ Kick Off clubs from an approved data source (source
  research done in PR-24; both are a §18 data-rights decision, not a code gap — the app already
  supports roles end-to-end and the club round only needs the eligibility rule broadened).
